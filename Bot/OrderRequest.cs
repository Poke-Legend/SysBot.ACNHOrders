...
namespace SysBot.ACNHOrders
{
    public class OrderRequest<T> : IACNHOrderNotifier<T> where T : Item, new()
    {
        ...
        public void OrderCancelled(CrossBot routine, string msg, bool faulted)
        {
            ...
            // Replace 'https://cancel.url' with the URL of the image you want to display when the order is cancelled
        ...
        {
            // Replace 'https://init.url' with the URL of the image you want to display when the order is initializing
        ...
        {
            // Replace 'https://ready.url' with the URL of the image you want to display when the order is ready
        ...
        {
            OnFinish?.Invoke(routine);
            // Replace 'https://finish.url' with the URL of the image you want to display when the order is finished
